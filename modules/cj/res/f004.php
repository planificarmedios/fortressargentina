...
-->
    ...
    <img align="left"  style="width:30%" src="sales_invoice/assets/img/logo.png"></br></br>
    				NUEVA FORMA DE PAGO DEL SERVICIO (ANEXO IX)</br>
    </h1>
                  ...
                  <tbody contenteditable>
                    <tr class="invoice_detail">
                      <td width="100%" style="text-align:left">
                        <blockquote>
                          <p><br>
                            <strong> Tipo de titularidad: </strong> Simple <br>
        ...
        <div class="row section" style="margin-top:-1rem">
            <div class="col-1">
                <table style='width:100%'>
                    <thead contenteditable>
                    <tr class="invoice_detail">
                      <th width="100%" >C. DATOS SOBRE FORMA DE PAGO</th>
                     </tr> 
                    </thead>
                  <tbody contenteditable>
                    <tr class="invoice_detail">
...
minor-latin;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin'> Autorizo por la presente a que el pago correspondiente a la contratación del servicio ofrecido por SEGURIDAD FORTRESS SA, sea debitado en forma directa y automática en el resumen de cuenta de la tarjeta o cuenta bancaria citada precedentemente y/o de sus correspondientes plazos. De la misma manera me comprometo a informar cualquier cambio de datos del medio citado. La presente autorización tiene validez desde este momento, hasta tanto medie comunicación fehaciente de mi parte para revocarla. Asimismo, faculto a SEGURIDAD FORTRESS SA de ser necesario, a presentar esta autorización a efectos de cumplimentar esta gestión. En la ciudad de Mar del Plata, a los …… del mes …………………………………  del año ……………</span> <o:p></o:p></span></b></p>
