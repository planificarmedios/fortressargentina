    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST"  action="../cj - Copia/modules/cj/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
...
<?php
  ...
  <section class="content-header" style="color:#000">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="../cj - Copia/?module=prices"> Servicios y Salas </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" style="color:#003" class="form-horizontal" action="../cj - Copia/modules/cj/proses.php?act=update" method="POST">
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="../cj - Copia/?module=cj" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
