...
<head>
    ...
    <link href="../cj - Copia/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- CUSTOM STYLE CSS -->

    <link href="../cj - Copia/assets/css/style.css" rel="stylesheet" />
...
<body >
       ...
       <form class="form-horizontal" role="form" id="datos_recibo" method="post">
        <div id="print-area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <a href="https://obedalvarado.pw/" target="_blank">  <img src="../cj - Copia/img/logo.png" alt="Logo sistemas web" /></a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
	...
	<script type="text/javascript" src="../cj - Copia/js/VentanaCentrada.js"></script>
