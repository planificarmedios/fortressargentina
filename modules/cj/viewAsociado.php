<section class="content-header" style="color:#003">
  <h1>     <i class="fa fa-lock icon-title"></i> Gestión de Asociados
    ...
    <a class="btn btn-warning btn-social pull-right" href="?module=form_cj&form=add" title="Agregar Asociado" data-toggle="tooltip">
  ...
  <h1>
        ...
        <?php
		  ...
		  $response = json_decode($get_data, true);
            ...
            if ($id_cliente == 0) {
			?> 
            <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="modules/cj/proses.php?act=delete&id=<?php echo $id;?>" onclick="return confirm('Se eliminará la caja nro. <?php echo $nrocaja; ?> ?');"><i style="color:#fff" class="glyphicon glyphicon-trash"></i></a>
