    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" style="color:#003" action="../cj - Copia/?module=formEdit_cj&formEdit=listarDisponibles" class="form-horizontal"  method="POST">
            <div class="box-body">
         ...
         <div class="box-footer">
            ...
            <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href='../cj - Copia/?module=cj' class="btn btn-danger">Volver</a>
                </div>
              </div>
...
<section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" style="color:#003" action="../cj - Copia/?module=formEdit_cj&formEdit=listarOcupadas" class="form-horizontal"  method="POST">
            <div class="box-body">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-warning" style="color:#003">
        ...
        <form role="form" class="form-horizontal" method="GET" action="../cj - Copia/modules/cj/exportData.php" target="_blank">
          <div class="box-body">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" style="color:#003" id="datos_recibo" class="form-horizontal" action="../cj - Copia/modules/cj/formPrint.php"  method="POST">
            <div class="box-body">
...
<section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" style="color:#003" id="datos_recibo" class="form-horizontal" action="../cj - Copia/modules/cj/formPrintAsociado.php"  method="POST">
            <div class="box-body">
...
<section class="content-header" style="color:#000">
  ...
  <ol class="breadcrumb">
    <li><a href="../cj - Copia/?module=cj"> Tarifario </a></li>
                  ...
                  <div class="box-footer">
                    <div class="form-group"> 
                      <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href='../cj - Copia/?module=form_prices&form=listar' class="btn btn-danger">Volver</a>
                      </div>
                    </div>
                  </div>
           </div>
