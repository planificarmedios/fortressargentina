	...
	<div align="center" class="limiter" style="background-image: url(images/nuevasCajas2.jpg);">
		<div align="center" class="container-login100">
			<div align="center" class="wrap-login100">
				...
				<form align="left" class="login100-form validate-form" action="login-check.php" method="POST">
      ...
      elseif ($_GET['alert'] == 5) {
       echo "<div style='text-align:center' class='alert alert-success wrap-input100 validate-input m-b-18'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-check-circle'></i>Datos registrados. En breve se enviará una clave de acceso.</h4>
              </div>";
      }
      ...
      elseif ($_GET['alert'] == 6) {
       echo "<div style='text-align:center' class='alert alert-success wrap-input100 validate-input m-b-18'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-check-circle'></i>Si los datos son correctos se enviará una nueva clave de acceso.</h4>
              </div>";
      }
      ...
      ?>  
					...
					<div align="center" class="wrap-input100 validate-input m-b-16" data-validate="Ingresar mail registrado">
						<input class="input100" type="text" id="username" name="username" placeholder="Ingresar mail registrado">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "Ingresar contraseña">
						<input class="input100"  type="password" id="password" name="password" placeholder="Ingresar contraseña">
						<span class="focus-input100"></span>
					</div>
          ...
          <div align="center" class="wrap-input100 validate-input m-b-18">               
                        <div align="center" class="g-recaptcha" data-sitekey="6LdludYUAAAAAHuKYB88n72h66UUBzncrxKvZHOm">
					     ...
					     <div  class="note"> 
                          <a href="ftpss.php" style="color:#03F">Olvidé contraseña</a>
                        </div>
                   
                        <div class="note"> 
                          <a href="lg.php" style="color:#03F">No soy Cliente</a>
                        </div>
					
                <div class="container-login100-form-btn">
                    <input type="submit" class="btn btn-outline-secondary btn-lg btn-block btn-flat" name="login" value="Ingresar" />
                </div>  
