<section class="content-header" style="color:#003">
    ...
    <ol class="breadcrumb">
      <li><a href="../cj - Copia/?module=start"><i class="fa fa-home"></i> Inicio</a></li>
    ...
    <div class="row">
          <div class="col-md-11">
            ...
            <div class="col-md-2 pull-left">
              <a class="btn btn-success btn-social" href="../cj - Copia/?module=formAddCaja_cj&formAddCaja=add" target="_blank">
                <i class="fa fa-plus"></i> Agregar Caja
              </a>
            </div>

            <div class="col-md-2 pull-left">
              <a class="btn btn-info btn-social" href="../cj - Copia/modules/cj/exportTotales.php" target="_blank">
              <i class="fa fa-file-excel-o"></i> Informe Auditoría 
                </a>
            </div>

            <div class="col-md-2 pull-left">
              <a class="btn btn-primary btn-social" href="../cj - Copia/?module=formPrintModule_cj&formPrintModule=listar">
  ...
  <h1>
        ...
        <?php
		  ...
		  $response = json_decode($get_data, true);
			...
			if ($id_cliente <> 0) {
			?> 
            <a href='../cj - Copia/?module=formPrintModule_cj&formPrintModule=print&id=<?php echo $id;?>&nrocaja=<?php echo $nrocaja;?>' data-toggle='tooltip' data-placement='top' title='Módulo Impresiones' style='margin-right:5px' class='btn btn-primary btn-sm' ><i style='color:#fff' class='glyphicon glyphicon-print'></i></a>
            <?php } else { ?>
