...
try {
 ...
 $response = json_decode($get_data, true);
              ...
              echo "
				   ...
				   <a data-toggle='tooltip' data-placement='top' title='Verificar' href='?module=form_acceso&form=print&id=$id&id_evento=$id_evento' style='margin-right:5px' class='btn btn-primary btn-sm'><i style='color:#fff' class='glyphicon glyphicon-print'></i></a>";
                    ?>
                   <?php
                   echo "      
                        </div>
