        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
					<a style="color:#D2C575" href="../main.php?module=cj" title="Volver">Volver Panel de Administración</a>
    ...
    <div class="container">
		...
		<div class="modal fade" id="ModalAdd" name="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="../MP/indexAdmin.php">
            
            				
				<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<center><h4 class="modal-title" id="myModalLabel">Gestión de Reservas Sala Gold</h4>
                		<center><h4 class="modal-title" id="myModalLabel"></h4>		
			  </div>
			  <div class="modal-body">
               ...
               <div class="form-group" name="idAdicionales" id="idAdicionales" hidden="hidden">
	...
	$(document).ready(function() {
       ...
       var dd  = (date.getDate()).toString().length == 1 ? "0"+(date.getDate()).toString() : (date.getDate()).toString();
		...
		$('#calendar').fullCalendar({
			...
			$jsonData = array( 'servicioID' => 2 ); ///////////////cambiar
