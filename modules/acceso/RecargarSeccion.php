  ...
  require_once ("../../fechaNumber.php");
	...
	$get_data = callAPI('GET', $servidor.'/api/access/SemaforoDisponibilidad/',false);
          ...
          $ocupados= $d['CANTIDAD'];
				...
				echo "	
				<div class='col-md-2' >
				  <a class='btn btn-danger btn-social' href='modules/acceso/proses.php?act=cambiar&valor=0'>
        ...
        <div class='col-md-2'>
          ...
          <div class='col-md-2' >
				...
				<div class='col-md-2'>
				  <a class='btn btn-success btn-social' href='modules/acceson/proses.php?act=cambiar&valor=1'>
				  <i class='fa fa-exclamation'></i> Restablecer Ingresos
					</a>
					</div>
					"; }
...
<center>
<h2 style="color:#000"><?php echo 'Hora Actual: '. $h.'hs'; ?> </h2>
