...
style='color:black;mso-themecolor:text1'>usuario se explicitan en el Anexo III
...
seguridad. Para la asignación de llaves, se ha solicitado al Cliente que, de un
grupo de un mínimo de cinco (5) sobres cerrados que contienen cada uno 2
llaves, seleccione al azar uno de ellos con 2 llaves idénticas en el interior
de éstos, y que se han programado para abrir la caja asignada. <o:p></o:p></span></p>
...
un escribano público designado por <b>SEGURIDAD FORTRESS SA </b> y con el costo a cargo
...
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>DE LA CONTRATACIÓN.</span></b><span lang=ES
style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
...
contrato se completará con Anexos y se sostendrá en la reglamentación de
...
color:black;mso-themecolor:text1'>Anexo</span></b><span lang=ES
style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin;color:black;mso-themecolor:text1'>: El convenio
de Locación se completará con el Anexo I donde constarán
todos los datos filiatorios del Locatario, y si correspondiere, el Anexo II de los autorizados donde constarán las personas
autorizadas para el uso de la Caja de Seguridad, el Anexo III con el tarifario que describe los precios y las caracteristicas de los servicios ofrecidos, el Anexo IV de solicitud de apertura forzada, Anexo V de reserva y usos de salas de reuniones, Anexo VI sobre medidas de seguridad y detección de metales y Anexo VII de las personas politicamente expuestas.<o:p></o:p></span></p>
...
periódicamente. <b>SEGURIDAD FORTRESS SA </b>deberá tener a disposición del Locatario 
una copia del reglamento vigente a partir de la puesta en vigor de éste, o en su defecto y a su criterio, 
publicar el mismo en la página web oficial de <b>SEGURIDAD FORTRESS SA</b>.<o:p></o:p></span></p>
...
como “frecuencia razonable” hasta 4 ingresos, contados para
...
por mes, <span style='color:black;mso-themecolor:text1'>contados para
su cálculo todos los accesos al sector de bóveda realizados por el titular y/o
autorizado/s desde el 01 hasta el último día corridos de cada mes.  Los ingresos excedentes a los incluidos en 
el plan contratado oportunamente serán facturados según tarifario vigente.-</span><o:p></o:p></span></p>
...
conferido en el Anexo II, debiendo registrar </span>los datos de todos los
...
una de las dos llaves entregadas. El Locatario debe firmar el Anexo II de alta del
Autorizado. En cualquier momento el Locatario podrá cancelar las autorizaciones otorgadas.<o:p></o:p></span></span></p>
...
titular, en todo caso <b>SEGURIDAD FORTRESS SA </b> debe contar con copia fiel del estatuto 
certificada por escribano y copia también certificada por escribano del última asamblea y reunión de directorio 
donde se hayan designado las autoridades. El Locador no se hace responsable por la entrada de apoderados una vez 
vencidos y/o revocados sus poderes por el Locatario, si el Locador no hubiera sido notificado fehacientemente de dicha circunstancia. <o:p></o:p></span></p>
...
En caso de que el Locatario sea una persona jurídica, el cambio de autorizados debe ser 
solicitado por quien contrato el servicio inicialmente. De no ser posible debe presentarse 
Acta de Asamblea y Acta de Directorio, certificadas por escribano público designando las 
nuevas autoridades y los nuevos autorizados, siempre y cuando conserven sus llaves caso 
contrario deberá adjuntar acta de directorio autorizando su forzamiento y abonar el costo 
del mismo completando el Anexo IV.<o:p></o:p></span></p>
...
informar si posee prótesis que pudieran activar estos dispositivos, contemplado en el Anexo VI. El local
contará con sistema de CCTV instalado en el recinto salvo zona de boxes,
...
LOS SERVICIOS ACCESORIOS.<o:p></o:p></span></b></p>
...
utilización de las salas de reuniones estará sujeta a una limitación temporal de
...
previas que estarán a su disposición en el Anexo V y en la sede de <b>SEGURIDAD
FORTRESS SA </b>. Para todo caso de reserva de salas, el Cliente podrá permanecer 
hasta el horario por <span class=GramE>éste</span> abonado y bajo las condiciones 
establecidas en el Reglamento de Uso y Reserva de Salas.<o:p></o:p></span></p>
...
mso-themecolor:text1'>ACOMPAÑAMIENTO:</span></u></b><span
...
mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;color:black;
mso-themecolor:text1'>NOTIFICACIÓN DE INGRESO A BÓVEDA:</span></u></b><b><span
lang=ES style='font-size:10.0pt;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
...
Bóveda. Este servicio tendrá un costo adicional fijado en el Anexo III.<o:p></o:p></span></p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><b><u><span
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>EL MONTO DEL CONTRATO</span></u></b><u><span lang=ES
style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>:</span></u><span lang=ES style='font-size:
10.0pt;line-height:115%;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin'>
El precio del contrato de Locación de Caja de Seguridad quedará establecido según el monto 
pactado en el Anexo I del Contrato que suscribirán el Locador y el Locatario. 
Dicho monto comprenderá todo el período de locación y se abonará por adelantado mensualmente por débito automático en tarjeta 
de crédito o pago por anticipado en el momento de suscribir el Contrato de Locación de Caja de Seguridad. 
<u><o:p></o:p></u></span></p>
...
mso-bidi-theme-font:minor-latin'>: </span></u><span lang=ES style='font-size:
10.0pt;line-height:115%;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin'>
Las listas de precios locativos y de los servicios adicionales pueden variar periódicamente. 
Tal actualización queda bajo exclusiva disposición del cliente y será informada por SEGURIDAD FORTRESS SA. 
con 30 dias de anticipación al mail registrado.<o:p></o:p></span></p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><b><u><span
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>DERECHO DE INSPECCIÓN:</span></u></b><span
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
...
Locatario en el plazo de 30 días corridos de notificado a tal
...
su contenido y ponerlo a disposición del Locatario durante el término de 30
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><b><u><span
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>MODIFICACIÓN</span></u></b><u><span lang=ES
style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'>:</span></u><span lang=ES style='font-size:
10.0pt;line-height:115%;mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin'>
...
el local <b>SEGURIDAD FORTRESS SA.</b> El Locatario se compromete a través
...
lang=ES style='font-size:10.0pt;line-height:115%;mso-bidi-font-family:Calibri;
mso-bidi-theme-font:minor-latin'> El Cliente acepta que, en caso de necesidad de forzamiento de la caja, el plazo para realizar 
el mismo deberá ser coordinado con el Locador sujeto a la disponibilidad de personal idóneo para realizarlo. El forzamiento 
puede ser solicitado por el cliente titular únicamente mediante el formulario establecido en el Anexo IV para dicho fin y en presencia de 
un funcionario de <b> SEGURIDAD FORTRESS SA</b>, el cliente y un escribano público. En caso de robo o extravió de las llaves 
de apertura del cofre, debe presentarse la denuncia policial correspondiente. El forzamiento tendrá un costo adicional según 
las tarifas vigentes al momento de hecho y estarán a cargo del Locatario.</span><span
