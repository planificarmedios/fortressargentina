...
<li class="dropdown user user-menu">
  ...
  <span class="hidden-xs"><?php echo $_SESSION['id_user'] . '-' . $n; ?> <i style="margin-left:5px" class="fa fa-angle-down"></i></span>
  </a>
  <ul class="dropdown-menu">
    ...
    <li class="user-footer">
     ...
     <div class="pull-left">
        <a style="width:110px" data-toggle="modal" href="#logout" class="btn btn-danger btn-flat">Cerrar Sesión</a>
      </div>
    </li>
  </ul>
</li>