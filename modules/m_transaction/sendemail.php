...
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template){
	...
	//$mail->addAddress('tecnica@medinillaseguridad.com.ar');   // Agregar quien recibe el e-mail enviado
	$mail->addAddress($_SESSION['email']);   // Agregar quien recibe el e-mail enviado
