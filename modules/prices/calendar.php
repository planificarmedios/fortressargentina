...
$query_obat = mysqli_query($mysqli, "SELECT * FROM services WHERE id = 294 ") or die('error '.mysqli_error($mysqli));
$data = mysqli_fetch_assoc($query_obat);
$intervalo = $data['intervalo'];
$idIn = $data['IdInicio'];
$idF = $data['idFin'];
$idFracc = $data['fraccion'];
$a = 1 ;

	for ($i=$idIn;$i<=$idF;$i++) { 
		$horarios[$a] = $i; 
		$a ++;
		$horarios[$a] = $i.'.'.$idFracc;
		$a ++;
	}
	
$query2 = mysqli_query($mysqli, "SELECT * FROM events WHERE idServicioReservado = '294' ") or die('error '.mysqli_error($mysqli));
$data2 = mysqli_fetch_assoc($query2);
$intervalo = '.30'; //cambiar valor cuando se reciba
$idIn = $data2['IdInicio'];
$idF = $data2['idFin'];
$a = 1 ;
...
<head>
<?php 
foreach($horarios as $x)	{ echo "Hs " . $x; echo ";";}
echo ('</br>');
foreach($reserva as $j)	{ echo "Reservas " . $j; echo ";";}
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="../mm - Copia/view.php">Menu</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p style="color:#096"  class="lead">Seleccionar fecha para consultar disponibilidad!</p>
