...
<section class="content-header" style="color:#000">
    ...
    <ol class="breadcrumb" style="color:#000">
      <li><a href=" ?module=afinidad"> Cajas </a></li>
  ...
  <section class="content" style="color:#000">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST"  action="../cj - Copia/modules/cj/proses.php?act=asociado" enctype="multipart/form-data">
            <div class="box-body">
             ...
             <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a  href="../cj - Copia/?module=cj" class="btn btn-danger btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          <!-- form start -->
          <form role="form" style="color:#003" id="datos_recibo" class="form-horizontal" action="../cj - Copia/modules/cj/proses.php?act=updateCliente" method="POST">
            <div class="box-body">
