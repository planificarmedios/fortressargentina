	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> Algo ha salido mal con el producto.
			</div>
			<?php
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
                    ...
                    <input type="hidden" value="<?php echo number_format ($valorDolar,2,'.','');?>" id="valorDolar<?php echo $id_producto;?>">
                    <input type="hidden" value="<?php echo number_format ($valor_venta_alpublico,2,'.','');?>" id="valor_venta_alpublico<?php echo $id_producto;?>">
					...
					<tr>
                        ...
                        <td><?php echo number_format($valorDolar,2);?></span></td>
                        <td><?php echo number_format($valor_venta_alpublico,2);?></span></td>
