  ...
  <body>
      ...
      <nav  style="font:'Paloseco Light'" class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div  style="font:'Paloseco Light'" class="container" id="comenzar" name="comenzar">
          <img src="images/horizontal.png" width="30%" height="15%"><h3 style="font:'Paloseco MediumItalic'"><a class="mb-4"  href="index.php"></a></center></h3>
    ...
    <section class="video-container" style="margin-top: 102px;">
        <video src="https://fortress.ggzdeveloper.com/assets/videos/video1.mp4" autoplay="" muted="" loop=""></video>
