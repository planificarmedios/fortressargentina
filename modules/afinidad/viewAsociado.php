<section class="content-header" style="color:#003">
  <h1>     <i class="fa fa-lock icon-title"></i> Gestión de Asociados

    <a class="btn btn-warning btn-social pull-right" href="../cj - Copia/?module=form_cj&form=add" title="Agregar Asociado" data-toggle="tooltip">
      <i class="fa fa-plus"></i> Agregar Asociado
    </a>
  </h1>
  ...
  <h1>
        ...
        <?php
		  ...
		  $response = json_decode($get_data, true);
            ...
            if ($id_cliente == 0) {
			?> 
            <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="../cj - Copia/modules/cj/proses.php?act=delete&id=<?php echo $id;?>" onclick="return confirm('Se eliminará la caja nro. <?php echo $nrocaja; ?> ?');"><i style="color:#fff" class="glyphicon glyphicon-trash"></i></a>
            <?php } elseif ($id_cliente > 0)  { ?>
