...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="../stock_report/?module=start"><i class="fa fa-home"></i> Inicio</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="../stock_report/modules/stock_report/print.php" target="_blank">
          <div class="box-body">
