...
if ($_SESSION['permisos_acceso'] == 'Administrador')  { ?>
	...
	<?php
      if ($_GET["module"]=="mm" || $_GET["module"]=="form_mm") { ?>
		<li class="active">
		  <a href="?module=mm"><i class="fa fa-list"></i> Reservas</a>
		  </li>
	  <?php
	  }
 ...
 if ($_GET["module"]=="s_inventory") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="?module=s_report"><i class="fa fa-list"></i> Reporte Historial </a></li>
          </ul>
      </li>
    <?php
  }
  elseif ($_GET["module"]=="stock_report") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?module=s_report"><i class="fa fa-list"></i> Reporte Historial  </a></li>
          </ul>
      </li>
    <?php
  }
